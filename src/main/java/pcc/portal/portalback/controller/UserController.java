...
//        if(userService.userExisted(user.getUsername())) {
...
////            return ResponseEntity.badRequest().body("This user has already existed");
//        }
...
//        if(userService.roleExisted(role.getName())) {
//            ResponseApi api = new ResponseApi();
//            api.setResponseCode("400");
//            api.setResponseStatus("ERROR");
//            api.setResponseMessage("ไม่สามารถบันทึกข้อมูลลงฐานข้อมูลได้");
//            return ResponseEntity.status(BAD_REQUEST).body(api);
////            return ResponseEntity.badRequest().body("This role has already existed");
//        }
...
//        if(userService.hasRole(username, roleName)) {
//            ResponseApi api =  new ResponseApi();
//            api.setResponseCode("400");
//            api.setResponseStatus("ERROR");
